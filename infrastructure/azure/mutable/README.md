# [Windows Web App for a .NET Application](https://github.com/Azure/terraform/tree/master/quickstart)
...
Terraform will perform the following actions:
  ...
  # module.terraformstate.azurerm_resource_group.infrastructure_rg will be created
  + resource "azurerm_resource_group" "infrastructure_rg" {
      + id       = (known after apply)
      + location = "southcentralus"
      + name     = "infrastructure-demo-tfquickstart-dev-rg"
    }

  # module.terraformstate.azurerm_storage_account.infrastructure_storage will be created
  + resource "azurerm_storage_account" "infrastructure_storage" {
      ...
      + primary_web_endpoint             = (known after apply)
      + primary_web_host                 = (known after apply)
      + resource_group_name              = "infrastructure-demo-tfquickstart-dev-rg"
      + secondary_access_key             = (sensitive value)
      + secondary_blob_connection_string = (sensitive value)
      + secondary_blob_endpoint          = (known after apply)
      + secondary_blob_host              = (known after apply)
  ...
  # module.terraformstate.azurerm_storage_container.infrastructure_container will be created
